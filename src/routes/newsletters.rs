...
use sha3::Digest;
use argon2::{Algorithm, Argon2, Version, Params, PasswordHash, PasswordVerifier};
...
pub async fn publish_newsletter(body: web::Json<BodyData>, pool:web::Data<PgPool>,
    email_client:web::Data<EmailClient>, request:HttpRequest)->Result<HttpResponse,PublishError> {
